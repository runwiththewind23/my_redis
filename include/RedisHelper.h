...
class RedisHelper {
 ...
 public:
  ...
  // 字符串操作命令
  std::string set(const std::string &key, const RedisValue &value,
                  const SET_MODEL model = NONE);
  ...
  std::string lrange(const std::string &key, const std::string &start,
