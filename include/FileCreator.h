...
class FileCreator {
  ...
  static void createFilesInDirectory(const std::string& path,
 ...
 public:
  static void createFolderAndFiles(const std::string& folderPath,
                                   const std::string& fileName,
                                   int numberOfFiles);
};
...
void FileCreator::createFilesInDirectory(const std::string& path,
                                         const std::string& fileName,
                                         int numberOfFiles) {
...
void FileCreator::createFolderAndFiles(const std::string& folderPath,
                                       const std::string& fileName,
                                       int numberOfFiles) {
